...
int list_push(list_t list, list_element_t elem);//add element to list (push)
int list_insert_at(list_t list, list_element_t elem, int pos);//insert at position pos
int list_print(list_t list);//print all list elements
